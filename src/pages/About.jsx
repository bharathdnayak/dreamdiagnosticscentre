      ...
      <section className="tech-showcase-section container">
        ...
        <div className="tech-grid">
          <div className="tech-card glass-card reveal-left">
            ...
            <p>
              Processes glucose, lipid profiles, liver parameters (LFT), and kidney metrics (KFT) using spectrophotometric measurement and automated calibrations, eliminating manual errors.
            </p>
          </div>
